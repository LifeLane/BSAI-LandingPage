        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <AnimatedElement key={index} delay={`delay-${index * 100}`}>
              <Card className="h-full shadow-xl hover:shadow-2xl transition-all duration-300 bg-card/70 backdrop-blur-sm border border-border hover:border-primary transform hover:-translate-y-2 group overflow-hidden hover:scale-105">
                <CardHeader>
