    ...
    return (
      <div className={cn("relative w-full", showBlinkingCursor && "blinking-cursor-container")}>
        <input
          type={type}
          className={cn(
            "flex h-9 w-full rounded-sm border border-primary/50 bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground/70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary focus-visible:shadow-neon-primary disabled:cursor-not-allowed disabled:opacity-60",
